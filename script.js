...
const projectData = [
    {
        ...
        title: "Objective Journey",
        description_pt: "Plataforma gamificada de Employee Experience desenvolvida de ponta a ponta. O sistema reúne autenticação JWT e Google OAuth, perfis de acesso, onboarding, trilhas de aprendizagem, campanhas, recompensas, dashboards, certificados com QR Code e relatórios em PDF e Excel.",
        description_en: "A full-cycle gamified Employee Experience platform. The system includes JWT and Google OAuth authentication, access roles, onboarding, learning paths, campaigns, rewards, dashboards, QR Code certificates, and PDF and Excel reports.",
        stack: ["React", "TypeScript", "NestJS", "PostgreSQL", "JWT", "OAuth", "PDF", "Excel"],
        image: "imgs/ObjectiveJourney.png",
        demoLink: "",
        repositoryLink: "",
        private: true
    },
...
const translations = {
    pt: {
        ...
        "extensions-title": "Conheça todas as minhas extensões",
        "extensions-description": "Reuni minhas ferramentas para Google Chrome em uma página única, organizada como uma pequena loja.",
        "extensions-button": "Abrir catálogo",
